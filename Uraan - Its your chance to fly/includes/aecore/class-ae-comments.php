...
class AE_Comments
{
    ...
    public function __construct($comment_type, $meta_key = array() , $post_type = '') {
        ...
        $this->duplicate_error = __('Already added.', 'enginethemes');
        $this->limit_time =  120;
    }
    ...
    public function fetch($args) {
        ...
        */
        ...
        ae_comments_pagination( $total, $args['page'] , $args );
    ...
    public function insert($args) {
        ...
        if($this->limit_time) {
            ...
            if (!empty($comments)) {
                ...
                if ($ago < ((int)$time)) return new WP_Error('fast_review', __("Please wait 2 minutes after each action submission.", 'enginethemes'));
            }
        }
        ...
        if(!$this->duplicate) {
            ...
            if (!empty($comments)) {
                if(isset($args['type'])) {
                    ...
                    return new WP_Error('duplicationde', __("You have already comment on this.", 'enginethemes'));
                }
            }
        }
