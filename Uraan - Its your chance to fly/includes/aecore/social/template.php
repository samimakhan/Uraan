...
function ae_page_social_connect(){
	...
	<?php } else if ($type == 'linkedin'){ ?>
		<p class="text-page-not social-big"><?php _e('SIGN IN WITH LINKEDIN','enginethemes');?></p>
	    <p class="social-small">
	        <?php
	...
	<div class="social-auth social-auth-step2">
	    ...
	    <p class="social-small"><?php _e('Please provide a username to continue','enginethemes');?></p>
		...
		<ul class="list-social-login">
	        ...
	        <li>
	        	<a href="#" class="gplus gplus_login_btn <?php echo $button_classes['gplus']; ?>" >
	        		...
	        		<span class="social-text"><?php _e("Plus", 'enginethemes') ?></span>
	        	</a>
	        </li>
	        <?php } ?>
	    	<?php if($use_twitter){ ?>
