...
class AE_WalletAction{
    ...
    public function charge($charge_obj = array()){
        ...
        if( $result >= 0 ){
            ...
            $response = array(
                'success'=> true,
                'msg'=> __("Successful payment!", 'enginethemes'),
                'id'=> $charge_id
            );
        }
        else{
    ...
    public function transfer( $transfer_obj ){
        ...
        if( $charge && !empty($charge) ) {
            ...
            if( $result < 0 ){
                $response = array(
                    'success'=> false,
                    'msg'=> __("You don't have enough money in you wallet!", 'enginethemes')
                );
                return $response;
            }
            ...
            $response = array(
                'success'=> false,
                'msg'=> __("There is no charge for this transfer!", 'enginethemes')
            );
        }
        return $response;
    }
