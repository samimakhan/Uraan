        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    ...
                    <?php
                        /* Conversation box */
                        mje_get_template( 'template/mjob-order/conversation.php', array( 'mjob_order' => $current ) );

                        /* Admin decision */
                        mje_get_template( 'template/mjob-order/admin-decision.php', array( 'mjob_order' => $current ) );

                        /* Related mjob, only showing for buyer */
                        mje_get_template( 'template/mjob-order/related-jobs.php', array( 'mjob_order' => $current) );
                    ?>
                </div>
